...
public class CatConstants {
    ...
    public static final String TYPE_TimeOut = "DubboTimeOut";
    ...
    public static final String TYPE_PIGEON_REQUEST = "DubboRequest";

    public static final String TYPE_PIGEON_RESPONSE = "DubboRespone";

    /**
     * Pigeon Event name
     */
    public static final String NAME_REQUEST = "DubboRequest";

    public static final String NAME_RESPONSE = "DubboRespone";
    ...
    public static final String RPC_CALL_FRAME = "Dubbo";

    public static final String RPC_CALL_SERVER = RPC_CALL_FRAME + "Call.server";

    public static final String RPC_CALL_APP = RPC_CALL_FRAME + "Call.app";

    public static final String RPC_CALL_PORT = RPC_CALL_FRAME + "Call.port";
