...
public class Handler implements PageHandler<Context> {
	...
	private void buildTransactionInfo(Payload payload, long date, DomainInfo info) {
		...
		TransactionReport serviceReport = queryTransactionReport(domain, ipAddress, date, "DubboService");

		new TransactionReportVisitor(ipAddress, info, "URL").visitTransactionReport(urlReport);
		new TransactionReportVisitor(ipAddress, info, "DubboService").visitTransactionReport(serviceReport);
	}
