...
public class TestSendMessage {
	...
	public void sentHackPigenTransaction() throws Exception {
		for (int i = 0; i < 200; i++) {
			Transaction t = Cat.getProducer().newTransaction("DubboCall", "Method3");
			Cat.getProducer().newEvent("DubboCall.server", "192.168.7.24:8080");
			Cat.getProducer().logEvent("RemoteCall", "Dubbo", Message.SUCCESS, "MessageID");
			t.addData("key and value");

			Thread.sleep(1);
			Cat.getManager().getThreadLocalMessageTree().setDomain("Dubbo");
	...
	public void sendPigeonClientTransaction() throws Exception {
		for (int i = 0; i < 100; i++) {
			Transaction t = Cat.getProducer().newTransaction("DubboCall", "Method3");
			Cat.getProducer().newEvent("DubboCall.server", "192.168.64." + i + ":2280");
			t.addData("key and value");
		...
		for (int i = 0; i < 100; i++) {
			Transaction t = Cat.getProducer().newTransaction("DubboCall", "Method3");
			Cat.getProducer().newEvent("DubboCall.server", "192.168.64.11:2280");
			t.addData("key and value");
		...
		for (int i = 0; i < 300; i++) {
			Transaction t = Cat.getProducer().newTransaction("DubboCall", "Method3");
			Cat.getProducer().newEvent("DubboCall.server", "192.168.7.39:8080");
			t.addData("key and value");
	...
	public void sendPigeonServerTransaction() throws Exception {
		for (int i = 0; i < 100; i++) {
			Transaction t = Cat.getProducer().newTransaction("DubboService", "Method6");
			Cat.getProducer().newEvent("DubboService.client", "192.168.7.77");
			t.addData("key and value");
		...
		for (int i = 0; i < 200; i++) {
			Transaction t = Cat.getProducer().newTransaction("DubboService", "Method8");
			Cat.getProducer().newEvent("DubboService.client", "192.168.7.20");
			t.addData("key and value");
		...
		for (int i = 0; i < 300; i++) {
			Transaction t = Cat.getProducer().newTransaction("DubboService", "Method5");
			Cat.getProducer().newEvent("DubboService.client", "192.168.7.231");
			t.addData("key and value");
